...
if (isset($_POST["cant1"])) {
    if (is_numeric($_POST["cant1"])) {
        ...
        for ($i=1; $i <= $count ; $i++) { 
            ...
            $base = $base.'<h4>Datos del '.$i.' Empleado</h4>
            ...
            <input type="number"    name="textd1'.$i.'" id="textd1'.$i.'" required>
            </div>
            <div >
            <label for="textd2'.$i.'">Ingrese las horas del 2 dia </label><br>
            <input type="number"  name="textd2'.$i.'" id="textd2'.$i.'" required>
            </div>
            <div >
            <label for="textd3'.$i.'">Ingrese las horas del 3 dia </label><br>
            <input type="number"  name="textd3'.$i.'" id="textd3'.$i.'" required>
            </div>
            <div >
            <label for="textd4'.$i.'">Ingrese las horas del 4 dia </label><br>
            <input type="number"  name="textd4'.$i.'" id="textd4'.$i.'" required>
            </div>
            <div >
            <label for="textd5'.$i.'">Ingrese las horas del 5 dia </label><br>
            <input type="number"  name="textd5'.$i.'" id="textd5'.$i.'" required>
            </div>
            <div class="form-group">
            <label for="textd6'.$i.'">Ingrese las horas del 6 dia </label><br>
            <input type="number" " name="textd6'.$i.'" id="textd6'.$i.'" required>
            </div><br></div>
            <hr>
            ';
           ...
           <input type="submit" c" value="     Enviar    ">';
           echo '</div>';
